...
Для сборки проекта нужно выкачать его из репозитрия, открыть в MSVC2010Express
файл WQuik.sln и выполнить Build -> Build Solution. При отсутствии ошибок, в
каталоге build появятся вышеперечисленные файлы. Сборка отладочной версии не
предусмотрена.
